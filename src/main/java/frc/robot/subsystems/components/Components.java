...
public class Components extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // poses[0] = new Pose3d(new Translation3d(0, 0, elevator.getPosition()), new Rotation3d());
    poses[0] =
        new Pose3d(
            new Translation3d(0, 0, elevatorPosition.get()),
            new Rotation3d(pivotPosition.get(), 0, 0));
